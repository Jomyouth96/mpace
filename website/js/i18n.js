...
(function () {
  var TRANSLATIONS = {
    th: {
      ...
      getting_there_desc: 'จากตัวเมืองเชียงใหม่ ใช้เส้นทางหลวงหมายเลข 107 (เชียงใหม่–ฝาง) มุ่งหน้าอำเภอแม่แตง แล้วเลี้ยวเข้าตำบลแม่หอพระตามป้ายบอกทาง ระยะทางประมาณ [ระยะทาง] กม. ใช้เวลาเดินทางประมาณ [เวลาเดินทาง] นาที เหมาะกับการเดินทางด้วยรถยนต์ส่วนตัว',
    ...
    en: {
      ...
      getting_there_desc: 'From Chiang Mai city, take Highway 107 (Chiang Mai–Fang) towards Mae Taeng District, then turn into Mae Ho Phra Subdistrict following the signs. Approximately [distance] km, about [travel time] minutes — best reached by private car.',
    ...
    zh: {
      ...
      getting_there_desc: '从清迈市区出发，沿107号公路（清迈–范）前往湄殿区，再依指示牌转入湄贺帕拉分区，全程约 [距离] 公里，车程约 [车程时间] 分钟，适合自驾前往。',
